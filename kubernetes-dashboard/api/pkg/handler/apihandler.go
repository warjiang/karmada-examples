...
import (
	...
	"kubernetes-dashboard/api/pkg/handler/parser"
	"kubernetes-dashboard/api/pkg/integration"
	"kubernetes-dashboard/api/pkg/resource/clusterrole"
	"kubernetes-dashboard/api/pkg/resource/clusterrolebinding"
	"kubernetes-dashboard/api/pkg/resource/common"
	"kubernetes-dashboard/api/pkg/resource/configmap"
	"kubernetes-dashboard/api/pkg/resource/container"
	"kubernetes-dashboard/api/pkg/resource/controller"
	"kubernetes-dashboard/api/pkg/resource/cronjob"
	"kubernetes-dashboard/api/pkg/resource/customresourcedefinition"
	"kubernetes-dashboard/api/pkg/resource/customresourcedefinition/types"
	"kubernetes-dashboard/api/pkg/resource/daemonset"
	"kubernetes-dashboard/api/pkg/resource/dataselect"
	"kubernetes-dashboard/api/pkg/resource/deployment"
	...
	"kubernetes-dashboard/api/pkg/resource/ingressclass"
	"kubernetes-dashboard/api/pkg/resource/job"
	"kubernetes-dashboard/api/pkg/resource/logs"
	ns "kubernetes-dashboard/api/pkg/resource/namespace"
	"kubernetes-dashboard/api/pkg/resource/node"
	"kubernetes-dashboard/api/pkg/resource/persistentvolume"
	...
	"kubernetes-dashboard/api/pkg/resource/replicationcontroller"
	"kubernetes-dashboard/api/pkg/resource/role"
	"kubernetes-dashboard/api/pkg/resource/rolebinding"
	"kubernetes-dashboard/api/pkg/resource/secret"
	"kubernetes-dashboard/api/pkg/resource/service"
	resourceService "kubernetes-dashboard/api/pkg/resource/service"
	"kubernetes-dashboard/api/pkg/resource/serviceaccount"
	"kubernetes-dashboard/api/pkg/resource/statefulset"
	"kubernetes-dashboard/api/pkg/resource/storageclass"
	"kubernetes-dashboard/api/pkg/scaling"
	"kubernetes-dashboard/api/pkg/validation"
)
