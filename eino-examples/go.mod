module eino-examples

go 1.23.6

require (
	github.com/cloudwego/eino v0.3.43
	github.com/cloudwego/eino-ext/components/embedding/openai v0.0.0-20250624023530-68a1e4282a8e
	github.com/cloudwego/eino-ext/components/model/ark v0.1.13
	github.com/cloudwego/eino-ext/components/model/ollama v0.0.0-20250620100056-146b562f0c16
